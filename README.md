...
ระบบเช็คชื่อนักเรียน (Student Attendance System) พัฒนาด้วย Next.js 14 สำหรับใช้งานในโรงเรียน รองรับการเช็คชื่อเข้าแถว ตรวจระเบียบวินัย และจัดการข้อมูลนักเรียน โดยมีการเชื่อมต่อฐานข้อมูลกับ Supabase และสามารถส่งข้อมูลสำรองไปยัง Google Sheets ได้
...
- **เช็คชื่อเข้าแถว (Attendance):** บันทึกสถานะการเข้าแถวของนักเรียน (มา, สาย, ลา, ขาด) 
- **ตรวจระเบียบวินัย (Uniform Check):** บันทึกผลการตรวจระเบียบระเบียบวินัย ทรงผม และเล็บ พร้อมสามารถระบุหมายเหตุได้
- **แดชบอร์ดสรุปผล:** มีการแสดงกราฟและสถิติข้อมูลการเข้าแถว ด้วย Chart.js
...
- `uniform_checks`: เก็บประวัติการตรวจระเบียบวินัย (`classroom`, `date`, `teacher_name`, `student_id`, `student_name`, `uniform_pass`, `hair_pass`, `nail_pass`, พร้อมระบุหมายเหตุ)

...
ระบบเช็คชื่อนักเรียน (Student Attendance System) พัฒนาด้วย Next.js 14 สำหรับใช้งานในโรงเรียน รองรับการเช็คชื่อเข้าเรียน ตรวจระเบียบวินัย และจัดการข้อมูลนักเรียน โดยมีการเชื่อมต่อฐานข้อมูลกับ Supabase และสามารถส่งข้อมูลสำรองไปยัง Google Sheets ได้
